...
internal class BillingDataSource(
    ...
    private val knownSubscriptionSKUs: List<String>? = if (knownSubscriptionSKUs == null) {
        ArrayList()
    } else {
    ...
    private val newPurchaseFlow = MutableSharedFlow<SubscribedPlan>(extraBufferCapacity = 1)
    ...
    suspend fun refreshPurchases() {
        ...
        var purchasesResult = billingClient.queryPurchasesAsync(BillingClient.SkuType.SUBS)
    ...
    private fun isSignatureValid(purchase: Purchase): Boolean {
        return SecurityKot.verifyPurchase(purchase.originalJson, purchase.signature)
    }
    ...
    companion object {
        private val TAG = "GoogleBilling:" + BillingDataSource::class.java.simpleName

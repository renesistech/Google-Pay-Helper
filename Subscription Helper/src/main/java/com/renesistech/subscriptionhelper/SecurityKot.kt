...
import com.renesistech.subscriptionhelper.BillingAppConstants.BILLING_SECURITY_SIGNATURE
...
internal object SecurityKot {
     ...
     */
    private val BASE_64_ENCODED_PUBLIC_KEY = BILLING_SECURITY_SIGNATURE
    ...
    fun verifyPurchase(signedData: String, signature: String?): Boolean {
        if (signedData.isEmpty() || BASE_64_ENCODED_PUBLIC_KEY.isEmpty()
